...
class iiwa14RobotHrpsysConfigurator(HrpsysConfigurator):
    def getRTCList (self):
        return self.getRTCListUnstable()
    def init (self, robotname="iiwa14", url=""):
    ...
    def defJointGroups (self):
        print("TODOOOOOOOOOOOOOOOOOOOOOOoo")
        ...
        larm_group = ['larm', ['iiwa_joint_1', 'iiwa_joint_2', 'iiwa_joint_3', 'iiwa_joint_4', 'iiwa_joint_5', 'iiwa_joint_6', 'iiwa_joint_7']]
...
if __name__ == '__main__':
    hcf = iiwa14RobotHrpsysConfigurator()
    if len(sys.argv) > 2 :
